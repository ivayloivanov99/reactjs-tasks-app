    ...
    render() {
       ...
       <div className="register-wrapper">
            <form className="register-form" onSubmit={this.onSubmit}>
                {this.state.errorMessage && <div className="alert alert-danger"><strong>{this.state.errorMessage}!</strong></div>}
                ...
                <div className="form-group">
                    ...
                    <input type="number" name="age" id="age" min="1" max="130" className="form-control" onChange={this.onInputChange} required />
                </div>
                <div className="form-group">
